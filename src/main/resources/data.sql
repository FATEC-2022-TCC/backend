...
INSERT INTO users (name, username, password, email, authority, created, created_by, updated, updated_by)
VALUE ("anonymousUser", "anonymousUser", "$2a$10$YFn5pXKY/ktIlIkCQ2OpmehUMriXHjdoJ12GWDyjKGT6cpa4Dhv4y", "anonymousUser@anonymousUser.com", "", NOW(), "SYSTEM", NOW(), "SYSTEM");

INSERT INTO users (name, username, password, email, authority, created, created_by, updated, updated_by)
VALUE ("admin", "admin", "$2a$10$YFn5pXKY/ktIlIkCQ2OpmehUMriXHjdoJ12GWDyjKGT6cpa4Dhv4y", "admin@admin.com", "ADMIN", NOW(), "SYSTEM", NOW(), "SYSTEM");
